...
export class MovementConstants {
  ...
  // Gravity
  public static readonly GRAVITY = 1400; // pixels/second² (stronger gravity for snappier platformer feel)
  public static readonly TERMINAL_VELOCITY = 500; // max fall speed
  
  // Jumping System
  public static readonly MIN_JUMP_VELOCITY = 280; // minimum jump speed (pixels/second) - reduced
  public static readonly MAX_JUMP_VELOCITY = 460; // maximum jump speed (pixels/second) - reduced
  public static readonly DOUBLE_JUMP_VELOCITY = 420; // double jump speed (pixels/second) - reduced
  public static readonly JUMP_HOLD_FRAMES = 8; // frames to hold for max jump (0.13 seconds at 60fps) - more responsive
  ...
  public static readonly WALL_JUMP_VERTICAL_VELOCITY = 380; // pixels/second (upward velocity) - reduced slightly
  ...
  // Dash Mechanics
  public static readonly DASH_DISTANCE = 150; // pixels (distance covered in ground dash) - increased for better mobility
  public static readonly DASH_DURATION_FRAMES = 8; // frames dash lasts (about 0.13 seconds)
  public static readonly DASH_VELOCITY = 1125; // pixels/second (calculated: 150px / (8 * 1/60)s = 1125px/s)
  ...
  public static readonly AIR_DASH_DISTANCE = 120; // pixels (increased for better mobility)
  public static readonly AIR_DASH_DURATION_FRAMES = 8; // frames air dash lasts (increased from 7)
  public static readonly AIR_DASH_VELOCITY = 900; // pixels/second (calculated: 120px / (8 * 1/60)s = 900px/s)
  ...
  public static readonly POGO_BOUNCE_FORCE = 380; // pixels/second upward velocity on pogo bounce - reduced slightly
